...
\includegraphics[width=0.7\textwidth]{./substation}
\end{flushleft}
\end{minipage}
\begin{minipage}{0.4\textwidth}
...
SubStation\cite{SubStation} and asa\cite{asa} teams in order to replace the old
...
AS5 has no official meaning. The ``A'' can stand for SubStation, asa, ASS or Advanced,
...
store program-specific data. For example, SubStation would create a group called
\emph{[Private:SubStation]} to store its data inside. This type of group is identified
...
\begin{itemize}
\item Generator: The name of the program that generated this script, e.g. \textit{``Generator: SubStation''}.
...
\bibitem{SubStation} Rodrigo Braz Monteiro, Niels Martin Hansen, David Lamparter et al., SubStation. Application, 2005-2007.\\
\url{http://www.substation.net/}
